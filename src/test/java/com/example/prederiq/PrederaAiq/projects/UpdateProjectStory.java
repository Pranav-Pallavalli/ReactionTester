...
public class UpdateProjectStory extends JUnitStories {
    ...
    public List<String> storyPaths() {
        return new StoryFinder().findPaths(CodeLocations.codeLocationFromClass(this.getClass()).getFile(), "**/update_project_story.story" ,"");
    }
    @Override
    @Test
    public void run() {
